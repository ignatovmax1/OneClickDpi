...
{
    var directory = Path.Combine(Path.GetTempPath(), "HelloDpi.Tests", Guid.NewGuid().ToString("N"));
...
{
    var paths = new EnginePaths(Path.Combine(Path.GetTempPath(), "HelloDpi.Engine.Tests"));
