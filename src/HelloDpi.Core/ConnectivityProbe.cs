...
public sealed class HttpConnectivityProbe : IConnectivityProbe, IDisposable
{
    ...
    public HttpConnectivityProbe()
    {
        ...
        _client.DefaultRequestHeaders.UserAgent.ParseAdd("HelloDpi/0.6 connectivity-check");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        socket.Options.SetRequestHeader("User-Agent", "HelloDpi/0.6 connectivity-check");
        var stopwatch = Stopwatch.StartNew();
