...
public sealed class TunnelConnectivityProbe : IDisposable
{
    ...
    public TunnelConnectivityProbe(int proxyPort = 19081)
    {
        ...
        _client.DefaultRequestHeaders.UserAgent.ParseAdd("HelloDpi/0.6.6 tunnel-check");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        socket.Options.SetRequestHeader("User-Agent", "HelloDpi/0.6.6 tunnel-check");
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var body = endpoint.Service == ServiceKind.ChatGPT
            ...
            var verdict = endpoint.Service == ServiceKind.ChatGPT
