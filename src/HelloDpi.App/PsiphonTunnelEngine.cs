...
public sealed class PsiphonTunnelEngine : IAsyncDisposable
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var configurationPath = Path.Combine(_dataDirectory, "HelloDpi-psiphon.json");
        ...
        CancellationToken cancellationToken)
    {
        ...
        configuration["ClientPlatform"] = "Windows_HelloDpi";
    ...
    private void RecoverStaleProcess()
    {
        ...
        try
        {
                ...
                && !process.HasExited)
            {
                ...
                LogReceived?.Invoke("Recovered a stale HelloDpi Psiphon process.");
            }
        }
