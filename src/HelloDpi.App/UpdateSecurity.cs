...
{
    private const string PublicKeyResourceName = "HelloDpi.UpdatePublicKey";
    private const string ChannelKeyResourceName = "HelloDpi.UpdateChannelKey";
    ...
    [GeneratedRegex(@"\AHelloDpi-MVP-[0-9]+\.[0-9]+\.[0-9]+-win-x64\.zip\z", RegexOptions.CultureInvariant)]
    private static partial Regex PackageNameRegex();

    [GeneratedRegex(@"\AHelloDpi-MVP-[0-9]+\.[0-9]+\.[0-9]+-win-x64\.ocdupdate\z", RegexOptions.CultureInvariant)]
