...
public sealed class TorTunnelEngine : IAsyncDisposable
{
    private static readonly IReadOnlyDictionary<string, string> ExpectedHashes =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["pt_config.json"] = "A7A4E3E4899680E82DCD240410F3FDFE61ED4A3C085EC4D39CCDF9760024F125",
            ["geoip"] = "D7E0E84C5BE8296F0155859448419E62FD29AB65CC3583A401FECE0A91DF3257",
            ["geoip6"] = "7DF65387BD4F2A5EAABE5337B5629B40753C14E74F3E46BD5F2D46C2C9AEFAA0"
        };
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var torrcPath = Path.Combine(_dataDirectory, "HelloDpi-torrc");
