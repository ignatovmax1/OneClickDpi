...
{
    public const string Repository = "ignatovmax1/DeskMax";
        ...
        HttpMessageHandler? handler = null)
    {
        ...
        _client.DefaultRequestHeaders.UserAgent.ParseAdd($"HelloDpi/{GetVersion()} updater");
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var manifestPath = Path.Combine(versionDirectory, "HelloDpi-update.json");
            var signaturePath = Path.Combine(versionDirectory, "HelloDpi-update.sig");
